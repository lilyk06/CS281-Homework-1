...
After seeing the RISC-V / x86-64 demonstration, how strongly did you want to understand **why the two architectures required different instructions to express the same computation?**
...
4. Strongly — the result made me want to understand the architectural tradeoff behind it.
...
| N2 | Provides a specific modern example, identifies the architectural consideration, and explains both what it buys and what it trades away with a credible source | 20 |
