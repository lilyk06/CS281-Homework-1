...
After seeing the row-major / column-major demonstration, how strongly did you want to understand **why changing only the order of memory accesses caused such a large performance difference?**
...
4. Strongly — the result made me want to understand what the memory hierarchy was doing.
...
| N2 | Provides a specific memory-hierarchy latency comparison for a named processor/family with a credible source | 20 |
