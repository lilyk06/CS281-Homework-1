...
- ☐ I mainly wanted to resolve why polling and interrupt-driven waiting produced the same visible result but very different amounts of CPU activity.
- ☐ I mainly wanted to understand the polling-versus-interrupt tradeoff well enough that I could explain or apply it beyond this assignment.
...
After seeing the polling / interrupt-driven demonstration, how strongly did you want to understand **why two programs producing the same visible result could involve such different amounts of CPU activity while waiting?**
...
4. Strongly — the result made me want to understand what the processor was doing differently.
...
|---|---|---:|
| MC1–MC4 | Correctly identifies the core concepts behind polling, interrupts, low-power waiting, and their engineering tradeoffs | 20 |
| N1 | States the corrected model: explains what the CPU is or isn't doing while waiting and why that matters for power | 20 |
| N2 | Provides a real, specific active-mode vs. sleep/low-power current comparison with a credible source | 20 |
