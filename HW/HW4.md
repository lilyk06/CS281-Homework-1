...
- ☐ I mainly wanted to understand why a processor designer might deliberately leave useful hardware out even when that hardware can make some operations much faster.
...
After seeing the hardware / software floating-point demonstration, how strongly did you want to understand **why a processor designer might deliberately leave out hardware that can make an operation substantially faster?**
...
4. Strongly — the result made me want to understand the architectural tradeoff behind the design decision.
