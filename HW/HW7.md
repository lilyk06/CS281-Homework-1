...
- ☐ I mainly wanted to understand why the CPU and GPU behaved so differently as the workload grew.
- ☐ I mainly wanted to understand how workload characteristics influence architectural design well enough that I could apply the idea beyond this assignment.
...
After seeing the CPU / GPU demonstration, how strongly did you want to understand **why the CPU dominated the smallest workloads while the GPU became much more effective as the amount of parallel work grew?**
...
4. Strongly — the result made me want to understand the architectural tradeoffs behind the behavior.
